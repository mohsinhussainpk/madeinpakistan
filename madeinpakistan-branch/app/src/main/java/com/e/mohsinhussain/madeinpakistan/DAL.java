...
public class DAL implements OnFailureListener {
...
//                .getDrawable(android.R.drawable.progress_horizontal));
        ...
        final Intent intent=new Intent(MainActivity.context,StoresActivity.class);//opening the  stores activity as soon as the
