...
public class SecondListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // MobileAds.initialize(this, "ca-app-pub-3940256099942544~3347511713");
        ...
        Adapter=new CustomListView(this,brands, DAL.getImageUrl1);
...
//                Log.d("Newlist:",brands.get(position))*/
        ...
        floatingActionButton1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                getOpenHomeIntent(SecondListViewActivity.this);
        ...
        floatingActionButton2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                //TODO something when floating action menu first item clicked
                getShareIntent(SecondListViewActivity.this);
        ...
        floatingActionButton3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                //TODO something when floating action menu first item clicked
                getExitIntent(SecondListViewActivity.this);
